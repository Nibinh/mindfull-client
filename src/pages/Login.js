...
import { login, logErrorMsg, logMsgDis } from "../stores/authSlice";
...
function Login() {
  ...
  const logMsg = useSelector((state) => state.auths.logMsg);
  const logError = useSelector((state) => state.auths.logError);
  const logId = useSelector((state) => state.auths.logId);
